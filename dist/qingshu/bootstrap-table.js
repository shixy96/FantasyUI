  ...
  */
  ...
  var BootstrapTable = /*#__PURE__*/function () {
    ...
    _createClass(BootstrapTable, [{
      ...
      key: "getPaginationFromTo",
      value: function getPaginationFromTo() {
        var opts = this.options;
        var from;
        var to;
      ...
      value: function initPagination() {
        ...
        if (this.paginationParts.includes('pageList')) {
          ...
          var fromTo = this.getPaginationFromTo();
          from = fromTo.from;
          to = fromTo.to;
  ...
  $__default["default"].extend($__default["default"].fn.bootstrapTable.locales['zh-CN'], {
    formatShowingRows: function formatShowingRows(pageFrom, pageTo, totalRows) {
      return "\u5171".concat(totalRows, "\u6761\u6570\u636E");
    },
    formatSRPaginationPageText: function formatSRPaginationPageText(page) {
      return "\u7B2C".concat(page, "\u9875");
    },
  ...
  $__default["default"].BootstrapTable = /*#__PURE__*/function (_$$BootstrapTable) {
    ...
    _createClass(_class, [{
      ...
      value: function initPagination() {
        ...
        $__default["default"]("<span class=\"transfer-info\">\u5230\u7B2C<input id=\"target-page-num\" value=\"".concat(opts.pageNumber, "\">\u9875<button class=\"transfer-btn btn btn-sx btn-gb\">\u786E\u5B9A</button></span></ul></div>")).appendTo(this.$pagination.find('ul'));

        if (!opts.onlyInfoPagination) {
          var $pageFirstSeparator = this.$pagination.find('.page-first-separator');
          var $pageLastSeparator = this.$pagination.find('.page-last-separator');
          var $transferBtn = this.$pagination.find('.transfer-btn');
          $pageFirstSeparator.off('click').on('click', function (e) {
            return _this.onPagePrevSuccessively(e);
          });
          $pageLastSeparator.off('click').on('click', function (e) {
            return _this.onPageNextSuccessively(e);
          });
          $transferBtn.off('click').on('click', function (e) {
            return _this.onPageJump(e);
          });
        }
      }
    }, {
      key: "onPagePrevSuccessively",
      value: function onPagePrevSuccessively(event) {
      ...
      key: "onPageNextSuccessively",
      value: function onPageNextSuccessively(event) {
      ...
      value: function onPageJump(event) {
        var targetNum = +$__default["default"]('#target-page-num').val();
      ...
      key: "initServer",
      value: function initServer(silent, query, url) {
        _get(_getPrototypeOf(_class.prototype), "initServer", this).call(this, silent, query, url);
